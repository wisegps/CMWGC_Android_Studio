...
public class WRotationProgressDrawable extends Drawable implements Animatable {
	...
	public WRotationProgressDrawable(int color, float sweepSpeed, float rotationSpeed, int sweepMin, int sweepMax) {
		mColor = color;
	...
	static class Build {
		...
		public WRotationProgressDrawable builder() {
			return new WRotationProgressDrawable(mColor, mSweepSpeed, mRotationSpeed, mSweepMin, mSweepMax);
		}
